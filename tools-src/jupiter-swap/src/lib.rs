...
impl Guest for Tool {
    ...
    fn description() -> String {
        "Execute a real token swap via Jupiter. Gets a quote, signs the transaction using the agent's keypair, and submits to Solana. Set confirmed:true. Common mints: SOL=So11111111111111111111111111111111111111112, USDC=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v, BONK=DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263".into()
    }
}
